...
function springeZuEintrag(neuerIndex) {
    ...
    switch (neuerIndex){
      case 0: 
        ...
        break;
        case 1: 
        textLink.dataset.url="https://nyrasaphira.itch.io/download-verdyn";
        ProjectTitle.textContent = "Verdyn";
        ProjectText.innerHTML = "3D Coop Jump n Run in Unreal Engine. After the original team project, I continued development independently, improving gameplay, visuals and polish while integrating the timer mechanic from my bachelor's thesis.";
        break;        
        case 2: 
        textLink.dataset.url="projects.html#secHopsie";
        ProjectTitle.textContent = "Hopsy Flopsy";
